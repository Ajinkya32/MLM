...
export const adminSlice = createSlice({
  ...
  reducers: {
    clearAdminSlice: (state) => {
      ...
      state.nonWorkingIncentiveDataAdmin = [];
      state.leadershipRewardsDataAdmin = [];
    },
  },
  ...
  extraReducers: {
    ...
    [getAnalyticsDataAdmin.fulfilled]: (state, { payload }) => {
      ...
      if (payload.nonWorkingIncentiveDataAdmin.length) {
        state.nonWorkingIncentiveDataAdmin = payload.nonWorkingIncentiveDataAdmin;
      }

      if (payload.leadershipRewardsDataAdmin.length) {
        state.leadershipRewardsDataAdmin = payload.leadershipRewardsDataAdmin;
      }
