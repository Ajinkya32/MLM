...
export default function NonWorkingIncentiveHistoryAdmin() {
  const { nonWorkingIncentiveDataAdmin } = useSelector((state) => state.adminSlice);

  const [data, setData] = useState([...nonWorkingIncentiveDataAdmin]);

  const [searchTerm, setSearchTerm] = useState("");

  const handleSearch = () => {
    let oldData = [...nonWorkingIncentiveDataAdmin];
  ...
  useEffect(() => {
    setData(nonWorkingIncentiveDataAdmin);
      ...
      <div className="topbar-div">
        ...
        <div className="dashboard-container ">
          ...
          <div className="incentiveHistory">
            <h2>Non-Working Incentive Reports </h2>
